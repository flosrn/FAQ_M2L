...
if (isset($_POST['submit'])) {  //Si l'on appuie sur le bouton submit en bas du formulaire
  ...
  $question = $con->quote($question); //fonction qui gère les apostrophes pour les questions
  $reponse = $con->quote($reponse); //fonction qui gère les apostrophes pour les réponses

  //On megt à jour les données dans la table à travers une requête SQL
  ...
  $questionok = "Votre question à bien été modifié";
...
<body>
    ...
    <div id="contenu">
      ...
      <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
       ...
       <p>Question<br /><textarea name="question" cols="40" row="10"><?php echo $question ?></textarea></p>
       <p>Réponse<br /><textarea name="reponse" cols="40" row="10"><?php echo $reponse ?></textarea></p>

       <input type="submit" value="Modifier" name="submit" /> <!--Bouton Submit-->
     </form><br />
